  ...
  return (
    <div className="about-container" id="about">
      <div className="text-about">
        ...
        <hr />
        <p>
          Hi! I'm Jordi, front-end developer. I started learning programming in
          a self-taught way combining it with my job. I graduated from the
        ...
        <p>
          I adapt myself to any position and situation in order to solve all the
          problems and overcome the proposed challenges to keep growing!
        </p>
        <hr />
