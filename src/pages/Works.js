      ...
      <div className="works-container" id="works">
        ...
        <div className="card-container">
          ...
          <div className="project-card-box" data-aos="zoom-out-down">
            ...
            >
              <h4 className="text">
                ...
                search by artist or event name. add or remove from favorites
                with links to purchase tickets.
                <hr />
          ...
          <div className="project-card-box" data-aos="fade-left">
            ...
            >
              <h4 className="text">
                My third project. A manager for dietitians where you can
                register your patients and keep track of all the parameters for
                the evolution of the patients.
                <hr />
                ReactJS | MongoDB |  NodeJS | ExpressJS | Javascript | HTML |
                CSS
              </h4>
